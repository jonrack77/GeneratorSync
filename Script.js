...
const FREQ_SYNC_LOW_HZ  = 59.5;  // lower bound for slower band
const FREQ_SYNC_HIGH_HZ = 60.5;  // upper bound for slower band
const FREQ_ACCEL_SYNC_HZ_S = .01; // accel rate within band
const FREQ_DECEL_SYNC_HZ_S = .01; // decel rate within band
